...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gradient-to-br from-purple-900 via-pink-800 to-indigo-900 min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ url('/dashboard') }}" class="text-white hover:text-yellow-300 transition-colors duration-200">
                            ...
                            @else
                                ...
                                @if (Route::has('register'))
                                    <a href="{{ \App\Helpers\LocalizedRoute::localized('register') }}" class="bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-white/20 hover:text-yellow-300 px-4 py-2 rounded-xl transition-all duration-200">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div class="text-center">
                    ...
                    <p class="text-xl md:text-2xl text-purple-200 mb-8 max-w-3xl mx-auto">
                        {{ __('messages.manga_price_search') }} {{ __('messages.manga_price_history') }} {{ __('messages.manga_used_price') }} {{ __('messages.manga_new_price') }}. 
                        {{ __('messages.manga_price_analysis') }} {{ __('messages.manga_price_tracker') }} {{ __('messages.manga_price_monitoring') }}.
                    </p>
        ...
        <!-- Features Section -->
        <div class="py-24 bg-white/5 backdrop-blur-sm">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">
                        {{ __('messages.manga_price_analysis') }} {{ __('messages.manga_price_tracker') }}
                    </h2>
                    <p class="text-xl text-purple-200 max-w-2xl mx-auto">
                        {{ __('messages.manga_price_estimation') }} {{ __('messages.manga_price_analysis') }} {{ __('messages.manga_price_research') }} {{ __('messages.manga_price_investigation') }} {{ __('messages.manga_price_study') }} {{ __('messages.manga_price_report') }}.
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6 text-center">
                        ...
                        <h3 class="text-xl font-semibold text-white mb-3">{{ __('messages.manga_price_search') }}</h3>
                        <p class="text-purple-200">
                            {{ __('messages.manga_price_finder') }} {{ __('messages.manga_price_scanner') }} {{ __('messages.manga_price_analyzer') }} {{ __('messages.manga_price_research') }} {{ __('messages.manga_price_investigation') }} {{ __('messages.manga_price_study') }}.
                        </p>
                    </div>
                    ...
                    <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6 text-center">
                        ...
                        <h3 class="text-xl font-semibold text-white mb-3">{{ __('messages.manga_price_history') }}</h3>
                        <p class="text-purple-200">
                            {{ __('messages.manga_price_tracker') }} {{ __('messages.manga_price_monitoring') }} {{ __('messages.manga_price_alert') }} {{ __('messages.manga_price_trend') }} {{ __('messages.manga_price_guide') }} {{ __('messages.manga_price_database') }}.
                        </p>
                    </div>

                    <!-- Feature 3 -->
                    <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6 text-center">
                        <div class="w-16 h-16 bg-gradient-to-br from-pink-400 to-red-500 rounded-full flex items-center justify-center mx-auto mb-4">
                            <i class="fas fa-calculator text-white text-2xl"></i>
                        </div>
                        <h3 class="text-xl font-semibold text-white mb-3">{{ __('messages.manga_price_calculator') }}</h3>
                        <p class="text-purple-200">
                            {{ __('messages.manga_price_estimator') }} {{ __('messages.manga_price_checker') }} {{ __('messages.manga_price_evaluation') }} {{ __('messages.manga_price_assessment') }} {{ __('messages.manga_price_appraisal') }} {{ __('messages.manga_price_quote') }}.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="py-24">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-8">
                        <h3 class="text-2xl font-semibold text-white mb-4">{{ __('messages.manga_price_analysis_report') }}</h3>
                        <div class="space-y-3 text-purple-200">
                            <div class="flex items-center">
                                <i class="fas fa-check-circle text-green-400 mr-3"></i>
                                <span>{{ __('messages.manga_price_research_report') }}</span>
                            </div>
                            <div class="flex items-center">
                                <i class="fas fa-check-circle text-green-400 mr-3"></i>
                                <span>{{ __('messages.manga_price_study_report') }}</span>
                            </div>
                            <div class="flex items-center">
                                <i class="fas fa-check-circle text-green-400 mr-3"></i>
                                <span>{{ __('messages.manga_price_investigation_report') }}</span>
                            </div>
                            <div class="flex items-center">
                                <i class="fas fa-check-circle text-green-400 mr-3"></i>
                                <span>{{ __('messages.manga_price_statistics_report') }}</span>
                            </div>
                            <div class="flex items-center">
                                <i class="fas fa-check-circle text-green-400 mr-3"></i>
                                <span>{{ __('messages.manga_price_data_report') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="py-24 bg-white/5 backdrop-blur-sm">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6 text-center">
                        <h4 class="text-lg font-semibold text-white mb-2">{{ __('messages.manga_price_details_service') }}</h4>
                        <p class="text-purple-200 text-sm">{{ __('messages.manga_price_summary_service') }} {{ __('messages.manga_price_overview_service') }}.</p>
                    </div>
                    <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6 text-center">
                        <h4 class="text-lg font-semibold text-white mb-2">{{ __('messages.manga_price_comparison_service') }}</h4>
                        <p class="text-purple-200 text-sm">{{ __('messages.manga_price_estimation_service') }} {{ __('messages.manga_price_analysis_service') }}.</p>
                    </div>
                    <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6 text-center">
                        <h4 class="text-lg font-semibold text-white mb-2">{{ __('messages.manga_price_research_service') }}</h4>
                        <p class="text-purple-200 text-sm">{{ __('messages.manga_price_study_service') }} {{ __('messages.manga_price_investigation_service') }}.</p>
                    </div>
                    <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6 text-center">
                        <h4 class="text-lg font-semibold text-white mb-2">{{ __('messages.manga_price_statistics_service') }}</h4>
                        <p class="text-purple-200 text-sm">{{ __('messages.manga_price_data_service') }} {{ __('messages.manga_price_information_service') }}.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6">
                        <h3 class="text-xl font-semibold text-white mb-4">{{ __('messages.manga_price_details_tool') }}</h3>
                        <p class="text-purple-200 mb-4">{{ __('messages.manga_price_summary_tool') }} {{ __('messages.manga_price_overview_tool') }} {{ __('messages.manga_price_comparison_tool') }} {{ __('messages.manga_price_estimation_tool') }}.</p>
                        <a href="{{ \App\Helpers\LocalizedRoute::url('price.search') }}" class="inline-block bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-6 py-2 rounded-lg hover:from-yellow-500 hover:to-orange-600 transition-all duration-300">
                            {{ __('messages.manga_price_search') }}
                        </a>
                    </div>
                    <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6">
                    ...
                    <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl p-6">
                        <h3 class="text-xl font-semibold text-white mb-4">{{ __('messages.manga_price_data_tool') }}</h3>
                        <p class="text-purple-200 mb-4">{{ __('messages.manga_price_information_tool') }} {{ __('messages.manga_price_details_tool') }} {{ __('messages.manga_price_summary_tool') }} {{ __('messages.manga_price_overview_tool') }}.</p>
                        <a href="{{ \App\Helpers\LocalizedRoute::url('price.historique') }}" class="inline-block bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-6 py-2 rounded-lg hover:from-yellow-500 hover:to-orange-600 transition-all duration-300">
                            {{ __('messages.history') }}
                        </a>
                    </div>
                </div>
        ...
        <!-- Footer -->
        <footer class="bg-black/20 backdrop-blur-lg border-t border-white/20 py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    <div class="flex items-center justify-center space-x-2 mb-4">
                        ...
                        <span class="text-lg font-bold bg-gradient-to-r from-yellow-400 to-pink-400 bg-clip-text text-transparent">
                            MangaValueCheck
                        </span>
                    </div>
